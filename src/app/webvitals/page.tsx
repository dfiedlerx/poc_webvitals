...
export default function Home() {
  return (
    <main className="mt-10 flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="w-50 m-10 m-auto mt-10">
        <img
      ...
      <div>
        <video
          src="https://videos.pexels.com/video-files/1110140/1110140-uhd_3840_2160_30fps.mp4"
          autoPlay
          muted
          loop
        >
      ...
      <div className="mt-10 mb-10 relative z-[-1] flex place-items-center before:absolute before:h-[300px] before:w-full before:-translate-x-1/2 before:rounded-full before:bg-gradient-radial before:from-white before:to-transparent before:blur-2xl before:content-[''] after:absolute after:-z-20 after:h-[180px] after:w-full after:translate-x-1/3 after:bg-gradient-conic after:from-sky-200 after:via-blue-200 after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff] after:dark:opacity-40 sm:before:w-[480px] sm:after:w-[240px] before:lg:h-[360px]">
        <Image
